    ...
    <div className="standings-section">
      <div className="standings-header">
        ...
        <div className="standings-toggle">
          <button className={`toggle-btn ${mode === "drivers" ? "active" : ""}`} onClick={() => handleToggle("drivers")}>
            {t("standings.drivers")}
          </button>
          <button className={`toggle-btn ${mode === "teams" ? "active" : ""}`} onClick={() => handleToggle("teams")}>
      ...
      <div className="standings-list" onMouseEnter={() => setIsPaused(true)} onMouseLeave={() => setIsPaused(false)}>
        {list.map((item) => {
